...
define("SMT_ROOT_PATH",__DIR__.'/../../');
define ( 'TEMPLATE_DIR', SMT_ROOT_PATH.'ViewPage/' );
define ( 'TEMPLATE_COMPILED', SMT_ROOT_PATH.'Storage/Smarty/compiled/' );
define ( 'TEMPLATE_PLUGINS', SMT_ROOT_PATH.'Vendor/Smarty/plugins/' );
define ( 'TEMPLATE_SYSPLUGINS',SMT_ROOT_PATH.'Vendor/Smarty/sysplugins/' );
define ( 'TEMPLATE_CONFIGS', SMT_ROOT_PATH.'Storage/Smarty/config/' );
define ( 'TEMPLATE_CACHE', SMT_ROOT_PATH.'Storage/Smarty/cache/' );
